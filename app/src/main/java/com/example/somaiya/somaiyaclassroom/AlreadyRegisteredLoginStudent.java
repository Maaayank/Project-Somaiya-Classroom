...
public class AlreadyRegisteredLoginStudent extends AppCompatActivity implements View.OnClickListener{
    ...
    private void UserLogin(){
        ...
        if(TextUtils.isEmpty(mail_id)){
            Toast.makeText(this, "Please enter an E-mail ID",Toast.LENGTH_SHORT).show();
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if(task.isSuccessful()){
                            ...
                            Toast.makeText(AlreadyRegisteredLoginStudent.this, "Invalid Username or Password. Try Again.",Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
